pcall(function()
    ...
    animListFrame.ClipsDescendants = false
    ...
    gazeLabel.Size = UDim2.new(1, -10, 0.1, 0)
    ...
    hideButton.MouseButton1Click:Connect(function()
        print("Hide button clicked") -- Debug print
        handleMinimize()
    end)
    ...
    Notify("Changelog", "Fixed hide button click issue, removed close button", 30)
end)
