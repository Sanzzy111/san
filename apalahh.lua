pcall(function() 
  ...
  availableLabel.Position = UDim2.new(0.05, 0, 0.2, 0)
  availableLabel.Parent = mainFrame

  -- Create Available Scroll Frame
  local scrollFrame = Instance.new("ScrollingFrame")
  scrollFrame.Name = "AvailableScroll"
  scrollFrame.Size = UDim2.new(0.45, 0, 0.6, 0) -- 60% of frame's height
  ...
  iconButton.Position = UDim2.new(0.95, -iconSize.X.Offset, 0.95, -iconSize.Y.Offset)  -- Bottom right corner
