...
local function createGUI()
    ...
    ControlsFrame.Size = UDim2.new(0, 0, 0, 0)
    ControlsFrame.Position = UDim2.new(0.5, 0, 0.5, 0)
...
print("===========================================")
print("[Freecam] Script loaded successfully!")
if isMobile then
    print("[Freecam] Mode: MOBILE")
    print("[Freecam] Tap icon kiri untuk toggle")
    print("===========================================")
    print("Kontrol:")
    print("  • Movement buttons - Bergerak")
    print("  • Up/Down arrows - Naik/Turun")
    print("  • +/- buttons - Zoom in/out")
    print("  • Swipe screen - Look around")
    print("  • Hide Controls - Sembunyikan tombol")
else
    print("[Freecam] Mode: PC/Keyboard")
    print("[Freecam] Tekan LeftShift + P untuk toggle")
    print("===========================================")
    print("Kontrol:")
    print("  • WASD/UHJK - Gerak")
    print("  • E/Q or I/Y - Naik/Turun")
    print("  • Mouse - Look around")
    print("  • Scroll - Zoom in/out")
    print("  • Shift - Gerak lebih lambat")
end
print("===========================================")
