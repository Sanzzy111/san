pcall(function()
    ...
    frame.Name = "SanBro"
    frame.Text = ""
    frame.Size = getScaledSize(0.25, 0.45)
    ...
    SanLabel.Size = UDim2.new(1, -10, 0.1, 0)
    SanLabel.Position = UDim2.new(0, 5, 0, 5)
    SanLabel.Parent = frame
    ...
    closeButton.MouseButton1Click:Connect(function()
        ...
        Notify("GUI", frame.Visible and "Opened" or "Closed", 1)
    end)
    ...
    statusFrame.Size = UDim2.new(0.9, 0, 0.25, 0)
    ...
    local statusLabels = {}
    for i, animType in ipairs(animationTypes) do
    ...
    resetAllButton.Size = UDim2.new(0.9, 0, 0.08, 0)
    resetAllButton.Position = UDim2.new(0.05, 0, 0.49, 0)
    ...
    scrollFrame.Size = UDim2.new(0.9, 0, 0.38, 0)
    scrollFrame.Position = UDim2.new(0.05, 0, 0.59, 0)
    ...
    local function handleDoubleClick()
        if isSmall then
            ...
            SanLabel.Size = UDim2.new(1, 0, 1, 0)
    ...
    local function loadLastAnimations()
        if isfile("MeWhenUrMom.json") then
            ...
            for animType, animId in pairs(lastAnimations) do
                ...
                currentAnimations[animType] = lastAnimations[animType .. "Name"] or "None"
                statusLabels[animType].Text = animType .. ": " .. currentAnimations[animType]
            end
        else
    ...
    local function setAnimation(animationType, animationId, animName)
        ...
        statusLabels[animationType].Text = animationType .. ": " .. currentAnimations[animationType]
        saveLastAnimations()
        unfreeze()
        Notify(animationType, animName .. " Applied", 1)
    end
    ...
    Notify("Changelog", "Added modern GUI, animation status, and reset functionality", 30)
end)
